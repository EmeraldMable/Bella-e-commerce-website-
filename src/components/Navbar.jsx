...
function Navbar() {
  return (
    <div className=' bg-white max-h-15 border-t-2 border-x-8 border-black'>
      <div className="container  mx-auto pl-20 pr-14 h-auto flex items-center justify-between">
