  ...
  return (
   ...
   <div className='w-auto mx-auto mt-5 ml-10 mr-10 lg:mt-8'>
      <div className='mx-auto max-w-6xl lg:flex' >
          ...
          <div className=' w-auto mx-10 my-auto pt-2 pb-2 sm:pt-4 sm:pb-6 text-center' >
         
            <p className=' text-base leading-7 sm:leading-10 sm:text-xl lg:text-2xl lg:leading-10'> Bella ဈေးအချိုဆုံးနှင့် အရည်အသွေးကောင်းသော cosmetic ပစ္စည်းများ  ထုတ်လုပ်ဖြန့်ချီသည့် <br 
            className='sm:hidden'
        ...
        <div className="w-auto mx-auto flex md:flex-col" >
          <div className=' w-full lg:w-2/3' >
            ...
            <Link className='w-auto' to='/'>
              <div className=' pt-2 pb-2 sm:pt-4 sm:pb-4 sm:mx-10 w-full text-left text-white flex md:relative md:-top-10 md:-left-10' style={{background:'#786262'}} >
                <p className=' text-base mx-1 sm:text-xl md:mx-5'>Gift Setများ</p>
